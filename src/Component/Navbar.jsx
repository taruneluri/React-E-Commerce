        ...
        <>
            <div className='py-4 shadow-md'>
                <ul className='container mx-auto flex flex-wrap justify-between md:flex-row px-4 md:px-2 items-center relative'>
                    <div className='flex gap-4 '>
                      <li>
                        <Link to="/React-E-Commerce">Home</Link>
                      </li>
                      <li>
                        <Link to="/React-E-Commerce">About</Link>
                      </li>
                      <li>
                        <Link to="/React-E-Commerce">FAQ's</Link>
                      </li>
                      <li>
                        <Link to="/React-E-Commerce">Contact</Link>
                      </li>
                    </div>
                    <div className={`${ isOpen ? "flex flex-col absolute right-0 md:right-0 top-12 z-10 bg-zinc-50 p-4 gap-4" : "hidden" }`}>
                      <li><Link to="/React-E-Commerce"> Sign</Link></li>
                      <li><Link to="/React-E-Commerce"> My Account</Link></li>
            ...
            <nav className="flex justify-between items-center container mx-auto md:py-6 py-8 px-2"> 
              <div className="flex items-center">
                <Link to="/React-E-Commerce" className="bg-gray-700 py-2 px-4 rounded cursor-pointer text-white">Lucide</Link>
              </div>
